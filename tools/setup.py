...
def main():
    ...
    print("""
  ######################################
  # A3H Development Environment Setup #
  ######################################

  This script will create your A3H dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your A3H project folder:
    [Arma 3 installation directory]\\{} => A3H project folder
    P:\\{}                              => A3H project folder
